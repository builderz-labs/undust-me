                ...
                {activeIndex === 0 ?
                    <>
                        <motion.div
                            ...
                            className=' border-undust-green border-opacity-20 rounded-lg  max-w-2xl w-full flex flex-col items-center justify-center gap-8 p-12 backdrop-blur-xl my-20'>
                            {wallet.connected ? <>
                                <button
                    ...
                    : activeIndex === 1 ?
                        <motion.div
                            ...
                            animate={{ opacity: 1 }}
                            transition={{ duration: 2, delay: 1 }}
                            className='border border-undust-green border-opacity-20 rounded-lg min-h-[250px] max-w-2xl w-full flex flex-col items-center justify-center gap-8 p-12 backdrop-blur-xl my-20'>
                            <div className='flex flex-col items-center justify-center gap-4 '>
                                ...
                                <button
                                    onClick={() => { closeEmptyAccounts(emptyAccountsData, wallet, connection) }}
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1 }}
                            transition={{ duration: 2, delay: 1 }}
                            className='border border-undust-green border-opacity-20 rounded-lg  max-w-2xl w-full flex flex-col items-center justify-center gap-8 p-12 backdrop-blur-xl my-20'>
                            <div>
