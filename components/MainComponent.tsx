                ...
                <button
                  onClick={() => {
                    if (emptyAccounts === 0) {
                      ...
                      if (emptyAccounts === 0) {
                        tweetText =
                          "I just scored a perfect 10/10 on my wallet. How clean is your wallet? Find out and earn SOL by using Undust.me https://undust.me/ ";
                      } else {
                        tweetText =
