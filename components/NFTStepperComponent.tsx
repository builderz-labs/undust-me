...
import NFTStepperItems from './NFTStepperItems';

function NFTStepperComponent({
  ...
  return (
    <>
      <div className="w-full flex flex-col items-center justify-center gap-4 container mx-auto h-full px-4">
        <h2>Your NFTs</h2>
        {wallet.publicKey ? (
          <>
            {loading ? (
              ...
              <div className="w-full">
                ...
                {selectedNfts.length > 0 && (
                  <>
                    <div className="w-full max-w-md flex flex-col items-center justify-center p-4 px-8 rounded-lg bg-black bg-opacity-80  border border-undust-green border-opacity-20 backdrop-blur-xl fixed top-8 z-[99] left-1/2 -translate-x-1/2">
...
export default NFTStepperComponent;
