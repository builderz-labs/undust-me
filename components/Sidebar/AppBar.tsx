...
export default function AppBar() {
  ...
  return (
    <header className="lg:hidden w-full fixed z-[999] !bg-black top-0">
      ...
      <Dialog as="div" className="" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-[999] transition-all duration-300 ease-in-out w-full overflow-y-auto bg-black px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
