      ...
      {nfts.map((nft: DAS.GetAssetResponse) => {
        ...
        return (
          <div
            ...
            key={nft.id}
            className={`relative flex flex-col items-center justify-center w-full h-full border border-undust-green border-opacity-20 rounded-lg ${
          ...
          >
            ...
            <div className="flex flex-col items-start justify-between w-full p-4 gap-8">
              ...
              <div className="flex flex-col justify-start items-start text-left w-full gap-2 font-bold">
                <span
                  className={`text-xl truncate w-[99%] ${
                    isSelected ? "text-red-500" : "text-white"
                  }`}
                >
                ...
                <span
                  className={`text-sm ${
                    isSelected ? "text-undust-green" : "text-white"
                  }`}
                ></span>
              </div>
            </div>
